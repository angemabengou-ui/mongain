...
export default function Settings({ token }: { token: string }) {
    ...
    return (
        <div style={{ maxWidth: '600px' }}>
            ...
            <form onSubmit={handleSave} style={{ display: 'flex', flexDirection: 'column', gap: '20px', backgroundColor: 'var(--bg-card)', padding: '20px', borderRadius: '12px' }}>

                <div style={{ backgroundColor: 'var(--bg-primary)', padding: '15px', borderRadius: '8px', borderLeft: '4px solid #3b82f6' }}>
                    ...
                    <input
                        ...
                        style={{ width: '100%', padding: '12px', borderRadius: '6px', backgroundColor: 'var(--bg-secondary)', border: 'none', color: 'var(--text-primary)' }}
                    />
                </div>

                <div style={{ backgroundColor: 'var(--bg-primary)', padding: '15px', borderRadius: '8px', borderLeft: '4px solid #f59e0b' }}>
                ...
                <div style={{ backgroundColor: 'var(--bg-primary)', padding: '15px', borderRadius: '8px', borderLeft: '4px solid #10b981' }}>
                ...
                <div style={{ backgroundColor: 'var(--bg-primary)', padding: '15px', borderRadius: '8px', borderLeft: '4px solid #ef4444' }}>
                ...
                <div style={{ backgroundColor: 'var(--bg-primary)', padding: '15px', borderRadius: '8px', borderLeft: '4px solid #a855f7' }}>
                ...
                <div style={{ backgroundColor: 'var(--bg-primary)', padding: '15px', borderRadius: '8px', borderLeft: '4px solid #f43f5e' }}>
                ...
                <div style={{ backgroundColor: 'var(--bg-primary)', padding: '15px', borderRadius: '8px', borderLeft: '4px solid #ef4444' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 10 }}>
                        ...
                        <button type="button" onClick={() => setAirtelEnabled(!airtelEnabled)} style={{ padding: '5px 12px', borderRadius: 20, backgroundColor: airtelEnabled ? '#10b981' : '#334155', border: 'none', color: 'var(--text-primary)', cursor: 'pointer', fontWeight: 'bold' }}>
                        ...
                        <>
                            <div style={{ marginBottom: 15 }}>
                                ...
                                <input
                                    ...
                                    style={{ width: '100%', padding: '10px', borderRadius: '6px', backgroundColor: 'var(--bg-secondary)', border: 'none', color: 'var(--text-primary)' }}
                                />
                            </div>
                            <div>
                ...
                <div style={{ backgroundColor: 'var(--bg-primary)', padding: '15px', borderRadius: '8px', borderLeft: '4px solid #3b82f6' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 10 }}>
                        ...
                        <button type="button" onClick={() => setMoovEnabled(!moovEnabled)} style={{ padding: '5px 12px', borderRadius: 20, backgroundColor: moovEnabled ? '#10b981' : '#334155', border: 'none', color: 'var(--text-primary)', cursor: 'pointer', fontWeight: 'bold' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '15px' }}>
                    <div style={{ backgroundColor: 'var(--bg-primary)', padding: '15px', borderRadius: '8px', borderLeft: '4px solid #f59e0b', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                        <label style={{ fontWeight: 'bold' }}>⚡ Électricité (SEEG)</label>
                        <button type="button" onClick={() => setSeegEnabled(!seegEnabled)} style={{ padding: '5px 12px', borderRadius: 20, backgroundColor: seegEnabled ? '#10b981' : '#334155', border: 'none', color: 'var(--text-primary)', cursor: 'pointer', fontWeight: 'bold' }}>
                            {seegEnabled ? 'ACTIF' : 'OFF'}
                        </button>
                    </div>
                    <div style={{ backgroundColor: 'var(--bg-primary)', padding: '15px', borderRadius: '8px', borderLeft: '4px solid #d946ef', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                        <label style={{ fontWeight: 'bold' }}>🤝 Tontine</label>
                        <button type="button" onClick={() => setTontineEnabled(!tontineEnabled)} style={{ padding: '5px 12px', borderRadius: 20, backgroundColor: tontineEnabled ? '#10b981' : '#334155', border: 'none', color: 'var(--text-primary)', cursor: 'pointer', fontWeight: 'bold' }}>
