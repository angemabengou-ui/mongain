...
const PERM_LABELS: Record<string, string> = {
    ...
    perm_reconciliation_resolve: 'Clôturer un écart de rapprochement agence',
    perm_market_view: 'Voir les annonces et séquestres marketplace',
    perm_market_manage: 'Trancher un séquestre bloqué (livrer / rembourser)',
...
const PERM_GROUPS = [
    ...
    { label: 'Marketplace C2C', perms: ['perm_market_view', 'perm_market_manage'] },
