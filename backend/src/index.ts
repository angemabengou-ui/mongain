...
import remitRoutes from './routes/remit';
...
app.use('/api/pay', circuitBreakerMiddleware, payRoutes);
app.use('/api/loyalty', circuitBreakerMiddleware, loyaltyRoutes);
app.use('/api/split', circuitBreakerMiddleware, splitRoutes);
app.use('/api/remit', circuitBreakerMiddleware, remitRoutes);
