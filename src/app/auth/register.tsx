                            ...
                            {step === 1 ? (
                                <>
                                    <View style={styles.inputGroup}>
                                        ...
                                        <View style={styles.inputContainer}>
                                            ...
                                            <Text style={{ fontSize: 16, fontFamily: 'Satoshi-SemiBold', fontWeight: '600', color: COLORS.textSecondary, marginRight: 8, borderRightWidth: 1, borderColor: COLORS.border, paddingRight: 8 }}>+241</Text>
                                            <TextInput
                                                style={styles.input}
                                    ...
                                    <TouchableOpacity onPress={handleRequestOtp} disabled={loading} activeOpacity={0.8}>
                                        <LinearGradient colors={['#2563FF', '#1D4ED8']} start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }} style={styles.submitBtn}>
                                ...
                                <>
                                    <Text style={{ color: COLORS.textSecondary, marginBottom: 16, fontSize: 13, lineHeight: 20 }}>
                                        Un code de vérification SMS a été envoyé au <Text style={{ fontFamily: 'Satoshi-SemiBold', fontWeight: '700', color: COLORS.textPrimary }}>+241 {phone}</Text>.
                                    </Text>
...
const getStyles = (COLORS: any) => StyleSheet.create({
    ...
    logo: { width: 64, height: 64, borderRadius: 20, backgroundColor: 'rgba(37, 99, 255, 0.1)', justifyContent: 'center', alignItems: 'center', marginBottom: 16 },
    appName: { fontSize: 32, fontFamily: 'Satoshi-SemiBold', fontWeight: 'bold', color: COLORS.textPrimary, marginBottom: 8, letterSpacing: -0.5 },
    tagline: { fontSize: 15, fontFamily: 'Satoshi-Regular', color: COLORS.textSecondary },
    ...
    title: { fontSize: 22, fontFamily: 'Satoshi-SemiBold', fontWeight: 'bold', color: COLORS.textPrimary, marginBottom: 24 },
    errorBox: { flexDirection: 'row', backgroundColor: COLORS.error + '20', padding: 12, borderRadius: 12, marginBottom: 20, alignItems: 'center' },
    errorText: { color: COLORS.error, fontSize: 13, fontFamily: 'Satoshi-Regular', marginLeft: 8, flex: 1 },
    inputGroup: { marginBottom: 20 },
    label: { fontSize: 12, fontFamily: 'Satoshi-SemiBold', color: COLORS.textSecondary, marginBottom: 8, textTransform: 'uppercase', letterSpacing: 0.5 },
    ...
    input: { flex: 1, height: 56, fontSize: 16, fontFamily: 'Satoshi-Regular', color: COLORS.textPrimary },
    eyeBtn: { padding: 8, marginRight: -8 },
    submitBtn: { height: 56, borderRadius: 16, justifyContent: 'center', alignItems: 'center', marginTop: 12, shadowColor: COLORS.primary, shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.3, shadowRadius: 15, elevation: 8 },
    submitBtnDisabled: { opacity: 0.7 },
    submitBtnText: { color: '#fff', fontSize: 17, fontFamily: 'Satoshi-SemiBold', fontWeight: 'bold' },
    footer: { flexDirection: 'row', justifyContent: 'center', alignItems: 'center', marginTop: 32, gap: 8 },
    footerText: { color: COLORS.textSecondary, fontFamily: 'Satoshi-Regular', fontSize: 14 },
    footerLink: { color: COLORS.primary, fontFamily: 'Satoshi-SemiBold', fontWeight: 'bold', fontSize: 14 },
});
