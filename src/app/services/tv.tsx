...
// Aucune intégration réelle avec Canal+ n'existe côté backend (voir
// backend/src/routes/services.ts, /pay-bill gardé derrière ENABLE_UNVERIFIED_EXTERNAL_SERVICES) :
// débiter le client ici reviendrait à prendre son argent sans jamais renouveler l'abonnement.
                ...
                <View style={styles.card}>
                    <View style={{ alignItems: 'center' }}>
                        ...
                        <Text style={[styles.subtitle, { textAlign: 'center', marginTop: 12 }]}>
                            Pas encore connecté à Canal+. Cette fonctionnalité est en cours de déploiement — aucun renouvellement d'abonnement ne peut encore être livré, elle reste désactivée pour ne pas débiter votre solde sans contrepartie.
                        </Text>
                    </View>
                </View>
            </ScrollView>
