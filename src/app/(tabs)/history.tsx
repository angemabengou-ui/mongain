...
const getStyles = (COLORS: ReturnType<typeof useAppTheme>) => StyleSheet.create({
    ...
    headerTitle: { color: COLORS.textHeader, fontSize: 24, fontFamily: 'Satoshi-SemiBold', fontWeight: 'bold' },
    ...
    filterText: { color: COLORS.textSecondary, fontFamily: 'Satoshi-SemiBold', fontWeight: 'bold' },
    filterTextActive: { color: '#ffffff' },
    listContainer: { paddingHorizontal: 20, paddingBottom: 40 },
    dateSeparator: { fontSize: 13, fontFamily: 'Satoshi-SemiBold', fontWeight: 'bold', color: COLORS.textSecondary, marginBottom: 12, marginTop: 8, marginLeft: 4 },
    transactionList: {
    ...
    txDetails: { flex: 1 },
    txTitle: { fontSize: 16, fontFamily: 'Satoshi-SemiBold', fontWeight: 'bold', color: COLORS.textPrimary, marginBottom: 4 },
    txName: { fontSize: 14, fontFamily: 'Satoshi-Regular', color: COLORS.textSecondary },
    statusPill: { alignSelf: 'flex-start', paddingHorizontal: 8, paddingVertical: 2, borderRadius: 8, marginTop: 4 },
    statusPillText: { fontSize: 11, fontFamily: 'Satoshi-SemiBold', fontWeight: 'bold' },
    txAmountContainer: { alignItems: 'flex-end' },
    txAmount: { fontSize: 16, fontFamily: 'Satoshi-SemiBold', fontWeight: 'bold', marginBottom: 4 },
    txDate: { fontSize: 12, fontFamily: 'Satoshi-Regular', color: COLORS.textSecondary },
    emptyContainer: { padding: 40, alignItems: 'center' },
    emptyText: { color: COLORS.textSecondary, fontSize: 16, fontFamily: 'Satoshi-Regular' },
});
